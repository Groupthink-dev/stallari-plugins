...
// Generated from data/agents.yaml + 18 pack manifests
...
- **stallari-core** v3.4.0 [calendar, email, tasks, vault]: Core platform operators and infrastructure health — PKM, comms, scheduling, security auditing, flee… (27 skills, 6 agents, free)
- **stallari-private-cloud** v0.2.0 [documentation, overlay-network, virtualmachine]: Provision and manage GPU cloud compute instances declaratively. Stands up stallari-gpu-worker nodes… (6 skills, 4 agents, free)
- **stallari-private-cloud** v0.3.0 [documentation, overlay-network, virtualmachine]: Provision and manage GPU cloud compute instances declaratively. Stands up stallari-gpu-worker nodes… (6 skills, 4 agents, free)
- **stallari-private-cloud** v0.3.1 [documentation, overlay-network, virtualmachine]: Provision and manage GPU cloud compute instances declaratively. Stands up stallari-gpu-worker nodes… (6 skills, 4 agents, free)
...
- **Declarative Infrastructure** v0.2.0 [documentation, overlay-network, virtualisation]: Provision and manage GPU cloud compute instances declaratively. Stands up stallari-gpu-worker nodes… (6 skills, 4 agents, free)
...
- **groupthink-operations** v1.4.0 [accounting, billing, transactional-email, vault]: Internal operations suite for Groupthink — Stallari ecosystem communications, billing lifecycle, fi… (11 skills, 2 agents, free)
- **stallari-private-cloud** v0.2.0 [documentation, overlay-network, virtualmachine]: Provision and manage GPU cloud compute instances declaratively. Stands up stallari-gpu-worker nodes… (6 skills, 4 agents, free)
- **stallari-private-cloud** v0.3.0 [documentation, overlay-network, virtualmachine]: Provision and manage GPU cloud compute instances declaratively. Stands up stallari-gpu-worker nodes… (6 skills, 4 agents, free)
- **stallari-private-cloud** v0.3.1 [documentation, overlay-network, virtualmachine]: Provision and manage GPU cloud compute instances declaratively. Stands up stallari-gpu-worker nodes… (6 skills, 4 agents, free)
...
- **stallari-sysadmin** v3.7.0 [billing, edge-platform, notifications, registry, transactional-email, vault]: Registry admin, platform monitoring, licensing ops, and release management for operating the Stalla… (30 skills, 3 agents, free)`;
...
export const PACK_NAMES = ["business-ops", "Declarative Infrastructure", "gaming-lounge", "home-maintenance", "meeting-intelligence", "network-observatory", "product-operations-starter", "saas-revenue-ops", "speculator", "stallari-core", "stallari-hearth", "groupthink-operations", "groupthink-operations", "stallari-private-cloud", "stallari-private-cloud", "stallari-private-cloud", "stallari-sysadmin", "stallari-sysadmin"] as const;
